...
CREATE TABLE Users (id int4 SERIAL NOT NULL, first_name varchar(255) NOT NULL, last_name varchar(255) NOT NULL, email varchar(255) NOT NULL UNIQUE, password varchar(255) NOT NULL, driving_score int4 DEFAULT 0 NOT NULL, user_type varchar(255) DEFAULT USER NOT NULL, PRIMARY KEY (id));
